...
impl Context {
    pub fn new() -> Self {
        Self{ transaction_methods: Vec::new(), fill_rect_parma_list: Vec::new(), set_fill_style_parma_list: Vec::new() }
    }

    pub fn fill_rect(&mut self, x: f64, y: f64, width: f64, height: f64) {
        self.transaction_methods.push(Transaction2DMethod::fill_rect);
        self.fill_rect_parma_list.push(FillRectTransitionParam{ x: x, y: y, width: width, height: height });
    }

    pub fn set_fill_style(&mut self, color: String) {
        self.transaction_methods.push(Transaction2DMethod::set_fill_style);
        self.set_fill_style_parma_list.push(SetFillStyleTransitionParam{ color });
    }
